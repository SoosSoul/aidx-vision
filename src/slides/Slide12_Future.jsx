...
export default function Slide04_AIIntro() {
  const cards = [
    ...
    },
    {
      ...
      description:
        "Built with privacy safeguards, bias checks, and auditability. Clear rationale and monitoring make models reliable, accountable, and ready for clinical workflows.",
      footIcon: BrainCircuit,
      delay: 0.4,
    },
  ];
